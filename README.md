...
- Startup will fail in staging/production if either secret still matches the defaults; in development (`ENVIRONMENT=development|dev|local`) the app only warns so you do not ship them by mistake.
